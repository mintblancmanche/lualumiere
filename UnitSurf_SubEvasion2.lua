...
破壊ユニットが魚雷を受けたことを確認する
UnitY ==4001



local unitx = ScenEdit_UnitX().unit

if unitx.subtype == 4001 then
...
-----
  ...
  local scripttext =
    ...
    '		 {latitude=contact.areaofuncertainty[1].latitude, longitude=contact.areaofuncertainty[1].longitude}) \r\n' ..
    '        if (aou > 2) and (contact.age < 1800) then \r\n' ..
    '            contact.posture = "H" \r\n' ..
    '        end \r\n' ..
    '    end \r\n' ..
    'end'
...
-----
  ...
  local scripttext =
    ...
    'DeleteAmbiguousSub ("' ..unity.side.. '", 10)'
