...
local point1 = World_GetPointFromBearing ({latitude = unit.latitude, longitude = unit.longitude, bearing = heading, distance = 50})

local rp1 = World_GetPointFromBearing ({latitude = point1.latitude, longitude = point1.longitude, bearing = 270+heading, distance = 20})
local rp2 = World_GetPointFromBearing ({latitude = point1.latitude, longitude = point1.longitude, bearing = 90+heading, distance = 20})
local rp3 = World_GetPointFromBearing ({latitude = rp2.latitude, longitude = rp2.longitude, bearing = 180+heading, distance = 40})
local rp4 = World_GetPointFromBearing ({latitude = rp1.latitude, longitude = rp1.longitude, bearing = 180+heading, distance = 40})
...
if selected.units ~= nil then --unit
  ScenEdit_AddReferencePoint({side=side, relativeto=unit.guid, bearing=rp1brg, distance=rp1dis, bearingtype=1, highlighted=true, locked=false})
  ScenEdit_AddReferencePoint({side=side, relativeto=unit.guid, bearing=rp2brg, distance=rp2dis, bearingtype=1, highlighted=true, locked=false})
  ScenEdit_AddReferencePoint({side=side, relativeto=unit.guid, bearing=rp3brg, distance=rp3dis, bearingtype=1, highlighted=true, locked=false})
  ScenEdit_AddReferencePoint({side=side, relativeto=unit.guid, bearing=rp4brg, distance=rp4dis, bearingtype=1, highlighted=true, locked=false})
else --contact
